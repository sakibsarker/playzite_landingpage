    ...
    <div className="overflow-hidden  ">
      <div className="relative flex flex-col items-start justify-start pb-5 md:pb-14 md:max-lg:pb-14 lg:max-xl:pb-14">
        ...
        <div className="relative z-10 text-start  px-5 py-10 md:px-32  md:py-40 md:max-lg:py-10 lg:max-xl:py-10 md:max-lg:px-10 lg:max-xl:px-10">
          ...
          <p
            className={`text-md md:text-3xl md:max-lg:text-2xl lg:max-xl:text-3xl pb-10 tracking-wide text-start items-start justify-start text-white ${jost.className}`}
          >
            <motion.span
              initial={{ y: "50%", opacity: 0 }}
              whileInView={{ y: "0%", opacity: 1 }}
